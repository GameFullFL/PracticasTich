...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <dl>
            ...
            <div class="col-sm-9">
                ...
                <dd>
                    ...
                    <br />
                    <asp:CustomValidator ID="cvCurpVSFechNac" runat="server" ErrorMessage="El curp y la fecha no coinciden" ControlToValidate="txtCurp" CssClass="text-danger" ClientValidationFunction="curpVsFecha"></asp:CustomValidator>  
                </dd>
    ...
    <div class="row">
        <div class="col-sm-2">
            <asp:Button ID="btnGuardar" runat="server" Text="Guardar" BackColor="#0066FF" BorderStyle="None" CssClass="btn-sm" ForeColor="White" OnClick="btnGuardar_Click" />
        </div>
        <div class="col-sm-2">
        </div>
        <div class="col-sm-8">
